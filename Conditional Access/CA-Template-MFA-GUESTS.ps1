...
# Read the JSON file
$jsonFilePath = ".\Require multifactor authentication for guest access.json"
try {
...
$templateContent = Get-Content -Path ".\Require multifactor authentication for guest access.json" -Raw
