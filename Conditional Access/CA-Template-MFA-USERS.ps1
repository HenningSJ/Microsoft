...
# Read the JSON file
$jsonFilePath = ".\Require multifactor authentication for all users.json"
try {
...
$templateContent = Get-Content -Path ".\Require multifactor authentication for all users.json" -Raw
