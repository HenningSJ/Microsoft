...
Get-InboxRule -mailbox post@taksthusetnord.no -IncludeHidden
...
Get-InboxRule -Mailbox Sigbjorn@taksthusetnord.no -includehidden | Format-List Name, Description, ForwardTo, RedirectTo, DeleteMessage, MoveToFolder 
