...
Get-InboxRule -mailbox erik@mydland.no -IncludeHidden
...
Get-InboxRule -Mailbox erik@mydland.no -includehidden | Format-List Name, Description, ForwardTo, RedirectTo, DeleteMessage, MoveToFolder 

#   Hvis du finner en mistenkelig regel, kan du fjerne den med følgende kommando:
Remove-InboxRule -Mailbox erik@mydland.no -Identity "regelnavn"
